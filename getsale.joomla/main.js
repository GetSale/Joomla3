...
jQuery(document).ready(function () {
    ...
    var support_text = "<br><br>Служба поддержки: <a href='mailto:plugins@getsale.io'>plugins@getsale.io</a><br>Joomla getSale v1.0.0";
    var success_text = "Поздравляем! Ваш сайт успешно привязан к аккаунту <a href='http://getsale.io'>getSale.io</a>. Войдите в личный кабинет для просмотра статистики.";
